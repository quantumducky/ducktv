...
async function playlistByGenres() {
  ...
  movies.slice(255,280).forEach(movie => {
      ...
      <div style="display: table; width: 100%; vertical-align:top;">
        ...
        <div style="display: table-cell; width: 40%;">
          ...
          <div style="font-size: 1.4em;">
            <div>
              <span style="color: #ffaf59;"><b>Šalis: </b></span><span style="color: #C0C0C0">${movie.country}</span>
            </div>
            <div>
              <span style="color: #ffaf59;"><b>Aktoriai: </b></span><span style="color: #C0C0C0">${movie.actors}</span>
            </div>
            <div>
              <span style="color: #ffaf59;"><b>Režisierius: </b></span><span style="color: #C0C0C0">${movie.director}</span>
            </div>
          </div>
        </div>
        ...
        <div style="display: table-cell; width: 60%; vertical-align:top; padding-left:8px; padding-right:8px; font-size: 1.4em;">
          ...
          <div>
            <img src="https://raw.githubusercontent.com/quantumducky/ducktv/master/img/imdb_124.png" width="16px"></img>&nbsp;<span style="color: #C0C0C0">${movie.imdbText ? movie.imdbText : '-'}</span>
          </div>
          <div>
            <span style="color: #ffaf59;"><b>Kalba: </b></span><span style="color: #C0C0C0">${movie.language}</span>
          </div>
          <div>
            <span style="color: #ffaf59;"><b>Metai: </b></span><span style="color: #C0C0C0">${movie.year}</span>
          </div>
          <div>
            <span style="color: #ffaf59;"><b>Žanrai: </b></span><span style="color: #C0C0C0">${movie.genres ? movie.genres.join(', ') : '-'}</span>
          </div>
          <div>
            <span style="color: #ffaf59;"><b>Trukmė: </b></span><span style="color: #C0C0C0">${movie.length}</span>
          </div>
          <div>
            <p>
