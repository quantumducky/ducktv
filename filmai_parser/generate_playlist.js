    ...
    <description><![CDATA[
      <div style="display: table; width: 100%; vertical-align:top;">
        ...
        <div style="display: table-cell; width: 40%;">
          <center>
            <div>
              <img src="${movie.posterURL}" style="border-radius: 25px; width: auto"></img>
            </div>
          </center>
        ...
        <div style="display: table-cell; width: 60%; vertical-align:top; padding-left:8px; padding-right:8px; font-size: 1.4em;">
          ...
          <div>
            <img src="https://raw.githubusercontent.com/quantumducky/ducktv/master/img/imdb_24.png" width="20px"></img>&nbsp;<span style="color: #ffaf59;"><b>IMDB: </b></span><span style="color: #C0C0C0">${movie.imdbText ? movie.imdbText.slice(6) : '-'}</span>
          </div>
          <div>
